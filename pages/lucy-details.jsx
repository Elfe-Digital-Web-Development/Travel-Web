              ...
              <div className="row">
                <div className="col-xl-6">
                  <div className="tour-title mb-20">
                    <h3 className="title">Lucy's Fossil</h3>
                    <p>
            ...
            <div className="row">
              <div className="col-xl-8">
                ...
                <div className="place-content-wrap pt-45 wow fadeInUp">
                  ...
                  <p>
                    Lucy’s fossil, discovered in Ethiopia's Afar region, is one
                    of the world’s most famous archaeological finds and a vital
                    link in human evolution. This 3.2-million-year-old partial
                    skeleton of Australopithecus afarensis revealed remarkable
                    insights into our ancestors, including evidence of
                    bipedalism. Named “Dinknesh” in Amharic, meaning “you are
                    marvelous,” Lucy’s discovery has made Ethiopia a key
                    destination for those fascinated by the origins of humanity.
                  </p>
                  <h4>Advance Facilities</h4>
                  <p>
                    Upon arrival, meet and be assisted by an Addisalem
                    representative. Lucy is known for her significant role in
                    understanding human evolution, offering insights into early
                    human ancestors through her 3.2-million-year-old fossil
                    remains. Here, you’ll explore the marvels of the Afar region
                    where Lucy was discovered, reflecting on her impact on
                    anthropology and our understanding of bipedalism. Widely
                    regarded as one of the most important discoveries in
                    science, Lucy offers a remarkable glimpse into Ethiopia’s
                    rich prehistoric heritage.y. Explore as much of this
                  ...
                  <div className="row align-items-lg-center">
                    ...
                    <div className="col-lg-7">
                      <img
                        src="assets/images/place/OIP.jpg"
                  ...
                  <div className="map-box mb-60 wow fadeInUp">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d252230.02028793565!2d38.613326426377796!3d8.963479545009857!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85cef5ab402d%3A0x8467b6b037a24d49!2sAddis%20Ababa!5e0!3m2!1sen!2set!4v1730448787348!5m2!1sen!2set"></iframe>
                  </div>
