              ...
              <div className="row">
                <div className="col-xl-6">
                  <div className="tour-title mb-20">
                    <h3 className="title"> Abijatta-Shalla National Park</h3>
                    <p>
            ...
            <div className="row">
              <div className="col-xl-8">
                ...
                <div className="place-content-wrap pt-45 wow fadeInUp">
                  ...
                  <p>
                    Abijatta-Shalla National Park, located in Ethiopia's Rift
                    Valley, is a unique sanctuary known for its breathtaking
                    landscapes and diverse wildlife. The park is home to two
                    stunning alkaline lakes, Abijatta and Shalla, whose
                    contrasting blue and green hues create a striking scene
                    against the surrounding savannas. Visitors can encounter
                    abundant bird species, including vibrant flamingos and
                    pelicans, while spotting gazelles, warthogs, and baboons
                    roaming the acacia-dotted plains. As a peaceful haven for
                    nature lovers and birdwatchers alike, Abijatta-Shalla offers
                    a serene retreat with panoramic views and a chance to
                    connect with Ethiopia’s remarkable biodiversity.
                  </p>
                  <h4>Advance Facilities</h4>
                  <p>
                    Upon arrival, meet and be assisted by an Addisalem
                    representative. Abijatta-Shalla is known for its
                    breathtaking landscapes and abundant wildlife, including a
                    vast array of bird species like flamingos and pelicans.
                    Here, you’ll explore the natural wonders of the Rift Valley,
                    visiting the contrasting alkaline lakes, Abijatta and
                    Shalla, which create stunning scenes against the
                    acacia-filled plains. Widely regarded for its serene beauty,
                    Abijatta-Shalla offers a remarkable chance to connect with
                    Ethiopia’s unique biodiversity. Explore as much of this
                    captivating park as you can.
                  </p>
                  <div className="row align-items-lg-center">
                    ...
                    <div className="col-lg-7">
                      <img
                        src="assets/images/place/download.jpg"
                  ...
                  <div className="map-box mb-60 wow fadeInUp">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.4163046809354!2d38.665905075002286!3d7.5294900924836226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x17b47500066aa59f%3A0xc6beb7bb22fdedd6!2sAbijatta-Shalla%20national%20park!5e0!3m2!1sen!2set!4v1730447743712!5m2!1sen!2set"></iframe>
                  </div>
