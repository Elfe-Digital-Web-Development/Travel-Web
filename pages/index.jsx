      ...
      <div className="fancy-icon-box-two">
        ...
        <div className="text">
          ...
          <p>
            ...
            from historical explorations to cultural immersions.
            We provide expertly curated tours that showcase
            Ethiopia's unique landscapes and heritage, ensuring
            an unforgettable journey for all travelers.
          </p>
        </div>
      </div>
    </div>
          ...
          >
            ...
            >
              ...
              <div className="text">
                ...
                <p>
                  We tailor every service to meet your specific needs, ensuring
                  personalized attention and results.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="text">
                ...
                <p>
                  We embrace the latest tools and strategies to keep you ahead
                  of the curve.
                </p>
              </div>
            </div>
